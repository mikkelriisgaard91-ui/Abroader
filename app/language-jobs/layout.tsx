...
export const metadata: Metadata = {
  title: "Language Jobs — Abroader",
  description:
    "Work abroad using your language skills. Telecommunication and customer roles across Europe with relocation support — hiring in 12+ countries.",
};

export default function LanguageJobsLayout({
  children,
}: Readonly<{
