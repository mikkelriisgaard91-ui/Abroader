  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity="0.6"
      />
      <circle cx="110" cy="140" r="5" fill="#e85a2f" />
      <circle cx="290" cy="130" r="5" fill="#e85a2f" />
      <circle cx="100" cy="220" r="4" fill="#f5a623" />
      <circle cx="310" cy="170" r="4" fill="#f5a623" />
      <defs>
        <radialGradient id="globeFill">
          <stop offset="0%" stopColor="rgba(232, 90, 47, 0.08)" />
